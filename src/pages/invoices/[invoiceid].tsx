...
// MAKE SURE VOID STATUS INVOICES CANT BE PAID
    ...
    <>
      ...
      <div className="flex flex-col items-center bg-gray-50">
        {txIsSuccess || isInvoicePaid ? (
          ...
          <>
            <div className="mt-5 w-[600px] text-center text-lg font-medium leading-6 text-gray-900">
              {personalInformation.name} has sent you an invoice!<br></br>
            </div>
            <div className="mt-5 w-[600px] text-center text-red-600">
              Pay using the button below <strong>only</strong>. Do not manually
              send funds directly to the address, or this invoice may remain
              marked as unpaid.
            </div>{' '}
            <button
              type="button"
