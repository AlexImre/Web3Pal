...
export default function AddInvoiceDisplay() {
  ...
  const { invoice, myInvoices, autoGeneratedInvoiceNumber } = masterState;
  const {
    invoiceId,
    status,
    txHash,
  ...
  console.log('autogeneratedinvoicenumber: ', autoGeneratedInvoiceNumber);
  ...
  const createNewInvoice = async () => {
    const newAutoGeneratedInvoiceNumber = await fetch(
    ...
    const invoiceNumber = await newAutoGeneratedInvoiceNumber.json();

    console.log('invoiceNumber: NEW GENERAETED', invoiceNumber);
